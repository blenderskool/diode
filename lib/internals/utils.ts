 ...
 */
export function expandObjectEntries(object: {
...
export function movingAverage(
  ...
  return Math.round(
    (apiRoute.avgResponseMs * apiRoute.successes + timeTaken) /
      (apiRoute.successes + 1)
  );
}
...
export function substituteSecrets(
  query: QueryParams | ExpandedHeaders,
